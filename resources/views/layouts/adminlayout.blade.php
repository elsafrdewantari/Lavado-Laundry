        ...
        <ul class="nav flex-column">
            <li>
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('image/logo.png') }}" alt="Laundry Lavado" style="margin-top:-10px;width: 150px; height: auto; margin-left:20px"> 
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('saran.index') }}">Saran</a>
            </li>
        </ul>
    </div>
