    ...
    <div class="row mt-4">
        <div class="col-md-6 mx-auto">
            <form class="d-flex align-items-center">
                ...
                <i class="bi bi-search">Cari</i> <!-- Ikon Bootstrap -->
                </button>
            </form>
        </div>
    </div>
                ...
                <div class="container mt-5 p-4 border rounded" id="Saran" style="margin-left:80px; margin-bottom:100px">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" placeholder="Masukkan saran Anda"></textarea>
                        </div>
...
<footer class="footer text-white py-3">
    <div class="container text-center">
        <div class="row">
            <!-- Logo dan Nama -->
            <div class="col-md-4">
                <img src="<?php echo e(asset('image/logo.png')); ?>" alt="Lavado Laundry" class="img-fluid mb-2" style="max-width: 100px;">
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\1. KULIAH SISTEM INFORMASI\Website_Lavado\resources\views/index.blade.php ENDPATH**/ ?>